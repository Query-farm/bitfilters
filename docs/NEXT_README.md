...
This extension, Bitfilters, allow you to ... <extension_goal>.
...
./build/release/extension/bitfilters/bitfilters.duckdb_extension
```
- `duckdb` is the binary for the duckdb shell with the extension code automatically loaded.
- `unittest` is the test runner of duckdb. Again, the extension is already linked into the binary.
- `bitfilters.duckdb_extension` is the loadable binary as it would be distributed.
